...
### DIY脚本仅供参考,需自行修改 jddj_cookiefile 参数,编辑docker-compose.yml文件添加: - CUSTOM_SHELL_FILE=https://raw.githubusercontent.com/passerby-b/JDDJ/main/shell_script_mod.sh

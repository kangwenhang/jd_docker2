# BiliExp
B站自动操作脚本(投币、点赞、分享视频，直播签到，直播开启宝箱领取银瓜子，直播挂机，自动送出快过期礼物，自动转发互动抽奖，漫画APP签到，参与官方抽奖活动，定时清理无效动态)</br>
...
* 2.部署
    ...
    *  2.2添加完上面4个"Secrets"后，进入"Actions" --》"deploy for ailiyun"，点击右边的"Run workflow"即可部署至阿里云函数
